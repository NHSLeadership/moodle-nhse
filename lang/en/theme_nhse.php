...
$string['copyright']                                   = 'Copyright notice (footer)';
$string['copyright_desc']                              = 'Anything you add here will appear in the footer copyright';
$string['copyright_default']                           = '&copy; NHS England';
...
$string['grid_columns_title']                          = 'Grid column layout';
$string['grid_columns_description']                    = 'Customise number of grid columns for home and course pages (default 1)';
$string['course_details_text']                         = 'Course details';
